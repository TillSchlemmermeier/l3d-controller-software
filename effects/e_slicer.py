...
class e_slicer():
    ...
    def return_gui_values(self):
        return bytearray('{0:<8s}{1:<8s}{2:<8s}{3:<8s}'.format(str(round(self.number,0)), str(self.channel), str(self.number),'') ,'utf-8')
