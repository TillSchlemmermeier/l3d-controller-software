...
class e_bright_mod():
    ...
    def return_values(self):
        return [b'bright mod', b'speed', b'amount', b'spread', b'channel']
    ...
    def return_gui_values(self):
        ...
        return bytearray('{0:<8s}{1:<8s}{2:<8s}{3:<8s}'.format(str(round(self.speed,2)),
                                                               str(round(self.amount,2)),
                                                               str(round(self.spread,2)),
                                                               channel), 'utf-8')
