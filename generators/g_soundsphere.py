...
#            timeout = 0.001
    ...
    def return_gui_values(self):
        return bytearray('{0:<8s}{1:<8s}{2:<8s}{3:<8s}'.format(str(round(self.maxsize,2)), str(round(self.channel,2)), str(round(self.smooth,2)), str(round(self.norm_trigger_value,2))),'utf-8')
