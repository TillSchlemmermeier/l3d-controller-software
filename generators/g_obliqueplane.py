...
class g_obliqueplane():
    def __init__(self):
        # create list of all filenames
        self.voxdata = []

        filelist = []
        for file in os.listdir('./voxFiles/obliqueplane/'):
        ...
        for file in filelist:
            self.voxdata.append(self.gen_world_from_file('./voxFiles/obliqueplane/'+file))
    ...
    def return_values(self):
        return [b'obliqueplane', b'wait', b'', b'', b'']
