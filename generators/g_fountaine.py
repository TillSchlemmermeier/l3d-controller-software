...
class g_fountaine():
    ...
    def return_values(self):
        return [b'fountaine', b'speed', b'thickness', b'size change', b'channel']
    ...
    def return_gui_values(self):
        ...
        return bytearray('{0:<8s}{1:<8s}{2:<8s}{3:<8s}'.format(str(round(self.speed,2)), str(round(self.thickness,2)), str(round(self.size_change,2)), channel),'utf-8')
