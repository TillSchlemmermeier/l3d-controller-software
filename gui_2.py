...
class App(Tk):
	...
	# load generators and effects
        self.generators = ["g_blank", "g_cube", "g_random", "g_growing_sphere","g_orbiter","g_randomlines",
                           ...
                           'g_growing_square', 'a_jukebox' , 'a_jukebox_ambient', 'g_swell', 'g_collision', 'g_soundsnake', 'g_supernova']
                           # 'g_2d_moving_line',  'a_pulsating', 'a_pulsating_torus' 'g_2d_randomlines',
                           # 'g_2d_growing_circle',
