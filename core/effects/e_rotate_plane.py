...
class e_rotate_plane():
    ...
    def return_state(self):
        return [
            ['X speed', 'xspeed', round(self.xspeed,2)],
            ['Y speed', 'yspeed', round(self.yspeed,2)],
            ['Z speed', 'zspeed', round(self.zspeed,2)],
            ['channel', 'channel', self.channel],
        ]
    
    def __call__(self, genworld, args):
        # === PARAMETERS START ===
        ...
        return np.clip(world*genworld, 0, 1)
