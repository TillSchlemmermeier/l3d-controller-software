...
#        self.list_widget.addItem(info)
    ...
    def update_fighter_values(self):
        ...
        self.stringArray_ch2[12].setText(str(self.global_label[28],'utf-8')+" : "+str(self.shared_mem_gui_vals.buf[176:182],'utf-8'))
        self.stringArray_ch2[13].setText(str(self.global_label[29],'utf-8')+" : "+str(self.shared_mem_gui_vals.buf[182:192],'utf-8'))
